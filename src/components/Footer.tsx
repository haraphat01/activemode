				...
				<div className="flex flex-wrap flex-row lg:justify-between -mx-3">
					<div className="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
						<div className="flex items-center mb-2">
							<span className="text-3xl leading-normal mb-2 font-bold text-gray-800 mt-2">Buildify</span>
							{/* <img src="src/img-min/logo.png" alt="LOGO">  */}
						</div>
						<p>Your Gateway to Building Your Dream Home in Africa.</p>
						<ul className="space-x-3 mt-6 mb-6 Lg:mb-0">
						
							<li className="inline-block">
								<a target="_blank" className="hover:text-gray-800" rel="noopener noreferrer"
			...
			<div className="container xl:max-w-6xl mx-auto px-4 py-4 border-t border-gray-200 border-opacity-10">
				<div className="row">
					<div className="col-12 col-md text-center">
						<p className="d-block my-3">Copyright © Active Mode Nig Ltd. | All rights reserved.</p>
					</div>
				</div>
			</div>
		</div>
